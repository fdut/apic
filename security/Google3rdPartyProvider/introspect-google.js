...
var customSSLProfile = apim.getTLSProfileObjName('tlsdefault');
...
apim.readInputAsBuffer(function (error, buffer) {
	...
	if (error) {
        ...
        //console.error("token: " + rtoken + " token_type_hint:" + rtoken_type_hint + " clientid:" + rclientid );
